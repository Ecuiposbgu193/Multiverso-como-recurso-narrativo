<p style="text-align:center; font-size:28px;">"MULTIVERSO COMO RECURSO NARRATIVO"</p><div style="display: flex; align-items: center;"><img src="M1.jpg" width="300" style="margin-right: 20px;"><span style="color:gold;">"Todo es posible cerca del multiverso"</span></div><div style="display: flex; align-items: center;"><span style="color:red;">En esta pagina veras lo que seria los multiversos en la ficcion, veremos temas como:
